...
News: **pfica** 0.1.1 has been released. This version includes some corrections on main the **pfica** functions. We also introduce shrinkage estimators to conduct  FICA functional data fitted with a larger basis dimension.
